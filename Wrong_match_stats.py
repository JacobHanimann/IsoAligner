...
chosen_columns = ['Gene name', 'Ensembl Gene ID (ENSG)', 'Ensembl Transcript ID (ENST)',
                      ...
                      'HGNC ID (HGNC:Number)']
big_nested_dict = {}
for index,gene in enumerate(list_of_gene_objects[0:4]):
...
big_df, check_list= Table_Generation.create_table_for_dict_of_gene_objects(big_nested_dict, list_of_gene_objects, chosen_columns,match, mismatch, open_gap_penalty,gap_extension_penalty)
print(check_list)